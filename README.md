...
Spotify Application project using Spotify Web API. React.js CSS Flexbox frontend and Node.js for OAuth backend. You can log in with your spotify account and visualize your playlists , see you top 10 favourite tracks and check the current "Now Playing" track. Some features like create a local playlist or search for an specific song are coming soon.
